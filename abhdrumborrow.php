<?php
	...
	$query='INSERT INTO Borrows(CName,PName,Quantity) VALUES ("Abhivyakti","Drums",1)';
	$result = mysql_query($query) or die(mysql_error());

echo'<form action="retabhdrumborrow.php" method="post"><input type="submit" value="Return" name="Return" ></input></form>';
?>