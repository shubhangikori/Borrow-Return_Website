<?php
	...
	$query='INSERT INTO Borrows(CName,PName,Quantity) VALUES ("Samvaad","Speakers",1)';
	$result = mysql_query($query) or die(mysql_error());
	echo'<form action="retsamHTSborrrow.php" method="post"><input type="submit" value="Return" name="Return" >Return</input></form>';
?>