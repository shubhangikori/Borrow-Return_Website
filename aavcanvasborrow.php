<?php
	...
	$query='INSERT INTO Borrows(CName,PName,Quantity) VALUES ("Aavartan","Canvas",1)';
	$result = mysql_query($query) or die(mysql_error());

	echo'<form action="retaavcanvasborrow.php" method="post"><input type="submit" value="Return" name="Return" ></input></form>';
?>