<?php
	...
	$query='INSERT INTO Borrows(CName,PName,Quantity) VALUES ("Samvaad","Harmonium",1)';
	$result = mysql_query($query) or die(mysql_error());
	echo'<form action="retsamcanvasborrrow.php" method="post"><input type="submit" value="Return" name="Return" >Return</input></form>';
?>