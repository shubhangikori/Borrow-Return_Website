<?php
	...
	$query='INSERT INTO Borrows(CName,PName,Quantity) VALUES ("Samvaad","Drums",1)';
	$result = mysql_query($query) or die(mysql_error());
	echo'<form action="retasamdrumborrrow.php" method="post"><input type="submit" value="Return" name="Return" >Return</input></form>';
?>