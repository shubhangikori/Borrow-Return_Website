				...
				<div id="banner">
					<div class="5grid 5grid-alt">
						...
						<div class="6u">
							...
							<!-- Banner Image -->
								<a href="#" class="bordered-feature-image"><img src="samvaad.jpg" height= "350px" width="100px" alt="" /></a>
					...
					<div class="5grid">
						<div class="4u-first">
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="HTS.jpg" alt="" /></a>
									<p>
									<a href="samHTSborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
									</section>';
									}
								}
						...
						<div class="4u">
							<!-- Box #2 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="canvas.jpg" alt="" /></a>
									<p>
									<a href="samcanvasborrow.php" class="drumborrow.php"><center>Borrow</center></a>
									</p>
								</section>';}}
								?>
						...
						<div class="4u">
							...
							<!-- Box #3 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="harmonium.jpg" alt="" /></a>
									<p>
									<a href="samharmoniumborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
								</section>';}}
								?>
						</div>
						<div class="4u-first">
							<!-- Box #1 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="drums.png" alt="" /></a>
									<p>
									<a href="samdrumborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
									</section>';
									}
								}
