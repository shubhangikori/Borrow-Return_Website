...
<html>
	<head>
		<title>Abhivyakti Home Page</title>
				...
				<div id="banner">
					<div class="5grid 5grid-alt">
						...
						<div class="6u">
							...
							<!-- Banner Image -->
								<a href="#" class="bordered-feature-image"><img src="abhivyakti.jpg" height= "350px" width="100px" alt="" /></a>
				...
				<div id="features">
					<div class="5grid">
						<div class="3u-first">
							...
							<!-- Feature #1 -->
								<section>
									<a href="#" class="bordered-feature-image"><img src="canvas.jpg" alt="" /></a>
									<h2>Canvas</h2>
									<p>
						...
						<div class="4u-first">
							<!-- Box #1 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="HTS.jpg" alt="" /></a>
									<p>
									<a href="abhHTSborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
									</section>';
									}
								}
						...
						<div class="4u">
							<!-- Box #2 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="drums.png" alt="" /></a>
									<p>
									<a href="#" class="abhdrumborrow.php"><center>Borrow</center></a>
									</p>
								</section>';}}
								?>
						...
						<div class="4u">
							...
							<!-- Box #3 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="harmonium.jpg" alt="" /></a>
									<p>
									<a href="abhharmoniumborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
								</section>';}}
								?>
						</div>
