...
<html>
	<head>
		<title>Aavartan Home Page</title>
	...
	<body>
		...
		$query = 'SELECT PName,CName,Quantity FROM Props';
		//Execute query
				...
				<div id="banner">
					<div class="5grid 5grid-alt">
						...
						<div class="6u">
							...
							<!-- Banner Image -->
								<a href="#" class="bordered-feature-image"><img src="aavartan.jpg" height= "350px" width="100px" alt="" /></a>
				...
				<div id="features">
					<div class="5grid">
						<div class="3u-first">
							...
							<!-- Feature #1 -->
								<section>
									<a href="#" class="bordered-feature-image"><img src="HTS.jpg" alt="" /></a>
									<h2>Speakers</h2>
									<p>
					...
					<div class="5grid">
						<div class="4u-first">
							<!-- Box #1 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="drums.png" alt="" /></a>
									<p>
									<a href="aavdrumborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
									</section>';
									}
								}
						...
						<div class="4u">
							<!-- Box #2 -->
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<a href="#" class="feature-image"><img src="canvas.jpg" alt="" /></a>
									<p>
									<a href="aavcanvasborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
								</section>';}}
								?>
						...
						<div class="4u">
							...
							<!-- Box #3 -->
								...
								$db=mysql_select_db('2016013');
								if(!$db){ die("Unable to select database"); }
									$qry='SELECT Quantity FROM Props WHERE PNAme="Harmonium"';
									$results=mysql_query($qry);
								$results=mysql_query($qry);
								//$var = mysql_fetch_row($results);
								...
								if (mysql_num_rows($results)==1)
								{
									...
									<header>
										<h2>Harmonium</h2>
										<h3>Jazbaat-The Dramatics Society</h3>
									</header>
									<a href="#" class="feature-image"><img src="harmonium.jpg" alt="" /></a>
								</section>';}
								else{
									echo '<section style = "opacity: 1.0;">
									<header>
									...
									<a href="#" class="feature-image"><img src="harmonium.jpg" alt="" /></a>
									<p>
									<a href="aavharmoniumborrow.php" class="feature-image"><center>Borrow</center></a>
									</p>
								</section>';}}
								?>
						</div>
